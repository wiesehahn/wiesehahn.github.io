...
DOP and bDOM originate from the same underlying imagery, but the available tiles and acquisition dates may differ because bDOM is generated only for a subset of images. Similarly, DGM and DOM are both derived from ALS data, but the available tiles and acquisition dates may differ.
...
dom1<- get_data("https://arcgis-geojson.s3.eu-de.cloud-object-storage.appdomain.cloud/dom1/lgln-opengeodata-dom1.geojson")
```
...
```{r}
#| echo: false
#| fig-cap: Distribution of DGM data in Lower Saxony by Day of Year
...
```{r}
#| echo: false
#| fig-cap: Distribution of DOM data in Lower Saxony by Day of Year

get_timespan(dom1)

plot_distribution(dom1)
```
:::
...
```{r}
#| echo: false
#| fig-cap: Most recent available DGM data coverage in Lower Saxony
...
```{r}
#| echo: false
#| fig-cap: Most recent available DOM data coverage in Lower Saxony
...
```{r}
#| echo: false
#| fig-cap: First available DGM data in Lower Saxony
...
```{r}
#| echo: false
#| fig-cap: First available DOM data in Lower Saxony
...
```{r}
#| echo: false
#| fig-cap: Available coverage of DGM data in Lower Saxony during leaf-off season (mid November - mid April)
...
```{r}
#| echo: false
#| fig-cap: Available coverage of DOM data in Lower Saxony during leaf-off season (mid November - mid April)
...
```{r}
#| echo: false
#| fig-cap: Available coverage of DGM data in Lower Saxony during leaf-on season (mid April - mid November)
...
```{r}
#| echo: false
#| fig-cap: Available coverage of DOM data in Lower Saxony during leaf-on season (mid April - mid November)
...
```{r}
#| echo: false
#| fig-cap: Latest coverage DGM data in Lower Saxony
...
```{r}
#| echo: false
#| fig-cap: Latest coverage DOM data in Lower Saxony
...
```{r}
#| echo: false
#| fig-cap: Number of DGM acquisitions per tile 
...
```{r}
#| echo: false
#| fig-cap: Number of DOM acquisitions per tile 
