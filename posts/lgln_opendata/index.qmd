...
get_timespan <- function(dat){
  ...
  cat("Images available from", min, "to", max, "\n")
}

plot_distribution <- function(dat){
  dat |> 
  ggplot(aes(x = doy, fill = year)) +
  geom_bar() +
  scale_x_continuous(
...
```{r}
#| echo: false
#| fig-cap: Available orthophoto coverage in Lower Saxony during leaf-off season (mid November - mid March)
...
```{r}
#| echo: false
#| fig-cap: Available coverage of image based height model in Lower Saxony during leaf-off season (mid November - mid March)
...
```{r}
#| echo: false
#| fig-cap: Available orthophoto coverage in Lower Saxony during leaf-on season (mid March - mid November)
...
```{r}
#| echo: false
#| fig-cap: Available coverage of image based height model in Lower Saxony during leaf-on season (mid March - mid November)
