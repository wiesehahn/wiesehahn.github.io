...
: Comparison of orthophoto compression types with overviews {.hover .responsive}
...
: Comparison of orthophoto compression types without overviews {.hover .responsive}
...
: Comparison of orthophoto compression by ERDAS and COG {.hover .responsive}
...
: Comparison of compression types for elevation data {.hover .responsive}
...
::: {.callout-note}
It is not entirely clear to me why a starting point of -10000 is used, as this is the limiting factor for the lowest elevation. The lowest elevation on earth (Mariana Trench) is approximately 10984 m deep, so this can not be encoded in this format. 
Also evelation values with higher precision (e.g. in the centimeter range) can not precisely encoded with a factor of 0.1.
:::
...
: Comparison of advanced compression types for elevation data {.hover .responsive}
...
: Comparison of elevation data and derived hillshade {.hover .responsive}
...
- [http://blog.cleverelephant.ca/2015/02/geotiff-compression-for-dummies](http://blog.cleverelephant.ca/2015/02/geotiff-compression-for-dummies)
- [https://wheregroup.com/blog/der-weg-zum-optimalen-geotiff](https://wheregroup.com/blog/der-weg-zum-optimalen-geotiff)
- [https://kokoalberti.com/articles/geotiff-compression-optimization-guide](https://kokoalberti.com/articles/geotiff-compression-optimization-guide)
- [https://gist.github.com/kgjenkins/877ff0bf7aef20f87895a6e93d61fb43](https://gist.github.com/kgjenkins/877ff0bf7aef20f87895a6e93d61fb43)
- [https://medium.com/@frederic.rodrigo/optimization-of-rgb-dem-tiles-for-dynamic-hill-shading-with-mapbox-gl-or-maplibre-gl-55bef8eb3d86](https://medium.com/@frederic.rodrigo/optimization-of-rgb-dem-tiles-for-dynamic-hill-shading-with-mapbox-gl-or-maplibre-gl-55bef8eb3d86)
