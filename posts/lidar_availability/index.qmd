...
abstract: | 
  The quality and availability of Airborne Laserscanning (ALS) data vary significantly by region. This article aims to provide an overview of ALS point cloud data and its derived products, such as Digital Terrain Models (DTMs) and Digital Surface Models (DSMs). Historically, lidar data has predominantly been available as commercial data. However, there is a gradual shift towards more open data policies recently.
...
image: lidar_availability_preview.jpg
image-alt: |
  Forest plot rendered from ALS data 
...
At the time of writing the initial plans can not be fulfilled anymore and a lot of details about the project are still not organised (see request on [https://fragdenstaat.de](https://fragdenstaat.de/anfrage/informationen-zum-projekt-digitaler-zwilling-deutschland/)). 
...
maplibre(style = "https://web3d.basemap.de/maplibre/bm_web_col.json",
         center = c(10, 52),
         zoom = 12
) |> 
