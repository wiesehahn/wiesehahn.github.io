...
abstract: | 
  The quality and availability of Airborne Laserscanning data varies heavily by region. To provide an overview this article tries to summarise information regarding ALS point cloud data and of derived products (DTM, DSM). While lidar data was available mainly as commercial data for long time this is slowly changing towards more open data policies. 
...
```{ojs}
fileContent = FileAttachment("https://raw.githubusercontent.com/wiesehahn/lidar-availability/main/availability_europe.md").text()
